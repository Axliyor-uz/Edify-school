...
/** Switchboard values (design.teacher.config.ts › StatTile_style). */
...
export interface StatTileProps {
  ...
  /** App-wide default comes from TEACHER_DESIGN.StatTile_style. Override sparingly. */
...
export function StatTile({
  ...
  progress,
  tone = "primary",
  variant = TEACHER_DESIGN.StatTile_style,
  className,
}: StatTileProps) {
  const iconClass =
