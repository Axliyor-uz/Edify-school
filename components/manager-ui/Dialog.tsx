...
import { MOTION_ON, MANAGER_DESIGN, springTransition } from "./config";
import { Button } from "./Button";
import { cn } from "./cn";

/** design.manager.config.ts › Dialog_style: 'sheet' turns the dialog into a
 *  bottom sheet on phones (< md); 'center' keeps the centered dialog everywhere. */
const SHEET_MODE = MANAGER_DESIGN.Dialog_style === "sheet";
