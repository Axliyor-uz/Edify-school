...
import { cn } from "./cn";
import { MOTION_ON, springTransition, MANAGER_DESIGN, type ManagerDesignConfig } from "./config";
...
export type TabsVariant = ManagerDesignConfig["Tab_style"];
...
export function Tabs({ tabs, value, onChange, className, variant }: TabsProps) {
  const style = variant ?? MANAGER_DESIGN.Tab_style;
