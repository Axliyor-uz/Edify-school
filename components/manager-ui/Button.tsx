...
import { cn } from "./cn";
import { MOTION_ON, MANAGER_DESIGN, type ManagerDesignConfig } from "./config";
...
/* ── Button_style switch (design.manager.config.ts) ─────────────────────────
...
type ButtonStyleName = ManagerDesignConfig["Button_style"];

const BUTTON_STYLE: ButtonStyleName = MANAGER_DESIGN.Button_style;
