...
/* ── Input_style switch (design.manager.config.ts) ──────────────────────────
   The default look of every field comes from MANAGER_DESIGN.Input_style; any
...
export type InputVariant = ManagerDesignConfig["Input_style"]; // 'outlined' | 'filled' | 'soft'

const DEFAULT_VARIANT: InputVariant = MANAGER_DESIGN.Input_style;
...
export interface TextFieldProps extends InputHTMLAttributes<HTMLInputElement> {
  ...
  /** Field style — defaults to MANAGER_DESIGN.Input_style. */
...
const SEARCH_RADIUS = MANAGER_DESIGN.Button_style === "pill" ? "rounded-full" : "rounded-m3-btn";
