...
interface Module {
  ...
  icon: any;
  price?: number;
  perStudent?: number;   // ai: monthly add per studen  t
  ai?: boolean;
...
const SUBJECTS = [
  ...
  { id: 'physics',   available: true, price: 59000, name: { uz: "Fizika", ru: "Физика", en: "Physics" } },
  { id: 'uzbek',     available: true, price: 49000, name: { uz: "Ona tili", ru: "Родной язык", en: "Uzbek (Native)" } },
  { id: 'biology',   available: true, price: 79000, name: { uz: "Biologiya", ru: "Биология", en: "Biology" } },
  { id: 'chemistry', available: true, price: 79000, name: { uz: "Kimyo", ru: "Химия", en: "Chemistry" } },
  { id: 'history',   available: true, price: 49000, name: { uz: "Tarix", ru: "История", en: "History" } },
] as const;
...
const MODULES: Module[] = [
  ...
  { id: 'auto_grade',cat: 'core', icon: CheckCircle2, price: 59000,
  ...
  { id: 'level_check', cat: 'core', icon: Target, price: 59000,
  ...
  // GROWTH
  { id: 'parent',    cat: 'growth', icon: UserCheck, price: 59000, perStudent: 1890, popular: true,
  ...
  { id: 'sms',       cat: 'growth', icon: Send, price: 0, perStudent: 5980,
...
const PER_STUDENT = 2000;              // monthly platform fee, per student
const BILLING = {
  monthly: { months: 1,  off: 0    },
  quarterly: { months: 4,  off: 0.05 },
  half:    { months: 6,  off: 0.12 },
...
const T = {
  uz: {
    ...
    students: "o'quvchi",
    billing: { monthly: "Oylik", quarterly: "3 oylik", half: "6 oylik", yearly: "Yillik" },
  ...
  ru: {
    ...
    students: "учеников",
    billing: { monthly: "Ежемесячно", quarterly: "3 месяца", half: "6 месяцев", yearly: "Год" },
  ...
  en: {
    ...
    students: "students",
    billing: { monthly: "Monthly", quarterly: "3 months", half: "6 months", yearly: "Yearly" },
